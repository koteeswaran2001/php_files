...
<?php
  $id=$_GET['id'];
  $sql1=mysqli_query($conn, "select * from form3 ")
  if(isset ($_POST['submit']))
    {
         ...
         <?php
         $id=$_GET['id'];
         $sql1= mysqli_query($conn, "select * from register where id='$id' ");
         $row1=mysqli_fetch_array($sql1);
          ...
          $sql=mysqli_query($conn, "update register set username ='$username', email = '$email', 
